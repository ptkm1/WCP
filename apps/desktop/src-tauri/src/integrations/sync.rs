...
use crate::db::{
    ...
    update_integration_sync_status, upsert_imported_work_item,
};
...
pub fn sync_organization_pm_tasks(
    ...
    for connection in connections {
        ...
        let secret = match load_credentials(&connection.credential_key) {
            Ok(value) => value,
            Err(error) => {
...
fn parse_sync_filter(raw: Option<&str>) -> SyncFilter {
